...
const StateNotifications = () => {
    const [notifications, setNotifications] = useState([
        { id: 1, title: 'District Proposal Submission Deadline', date: '2025-11-22', audience: 'All Districts', status: 'Sent' },
        { id: 2, title: 'New UC Format Guidelines', date: '2025-11-10', audience: 'All Districts', status: 'Sent' },
    ]);

    const [isModalOpen, setIsModalOpen] = useState(false);
    const [formData, setFormData] = useState({ title: '', message: '', audience: 'All Districts', scheduleDate: '' });
    ...
    const handleCreate = () => {
        ...
        setFormData({ title: '', message: '', audience: 'All Districts', scheduleDate: '' });
    };
