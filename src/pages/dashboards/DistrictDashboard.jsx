...
const DistrictDashboard = () => {
    ...
    const sidebarMenu = [
        ...
        { icon: '✅', label: 'Approve GP Proposals', path: '#' },
        { icon: '🏗️', label: 'Assign Works & Departments', path: '#' },
        { icon: '📋', label: 'Tender/Contract Management', path: '#' },
        { icon: '🗺️', label: 'Monitor Works Progress (GIS)', path: '#' },
        { icon: '📄', label: 'Upload Reports', path: '#' },
        { icon: '💰', label: 'Manage Payments & Invoices', path: '#' },
            ...
            <main className="dashboard-main">
                <div className="dashboard-header">
                    <div className="dashboard-title-section">
                        <h1>Pune District Dashboard</h1>
                        <p>District Collector / DPCC - Project Management & Monitoring</p>
                    </div>
